...
void obstacleStopper_initialize(void){
  ...
  {
    static const char_T tmp[24] = { '/', 'a', 'l', 'l', '_', 'i', 'n', '_', 'o', 'n', 'e',
                                  '/', 'c', 'm', 'd', '_', 'v', 'e', 'l', '_', 's', 'a', 'f', 'e' };

    static const char_T tmp_0[19] = { '/', 'a', 'l', 'l', '_', 'i', 'n', '_', 'o', 'n', 'e',
                                  '/', 'c', 'm', 'd', '_', 'v', 'e', 'l'};

    static const char_T tmp_1[35] = { '/', 'a', 'l', 'l', '_', 'i', 'n', '_', 'o', 'n', 'e',
                                    '/', 'd', 'i', 's', 't', 'a', 'n', 'c', 'e', 'E', 's', 't', 'i',
                                    'm', 'a', 't', 'o', 'r', '/', 'd', 'i', 's', 't' };
