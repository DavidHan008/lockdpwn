		...
		, init_argc(argc), init_argv(argv), _ui(ui)
{
	...
	possub = n.subscribe("LocalizationData", 100, &VelocityCtrlThread::LocalizationTopicProcess, this);//JW 07.20.
        //possub = n.subscribe("my_pose2", 10, &VelocityCtrlThread::LocalizationTopicProcess, this);//JW 07.20.
...
void VelocityCtrlThread::TargetVelUpdate(float targetVel)
{
	...
	qDebug()<<"Thread::PosTopicProcess x:"<<m_targetVel<<endl;
}
