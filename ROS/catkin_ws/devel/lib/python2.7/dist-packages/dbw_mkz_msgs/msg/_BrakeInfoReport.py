...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4f10B.pack(_x.brake_torque_request, _x.brake_torque_actual, _x.wheel_torque_actual, _x.accel_over_ground, _x.hsa.status, _x.hsa.mode, _x.abs_active, _x.abs_enabled, _x.stab_active, _x.stab_enabled, _x.trac_active, _x.trac_enabled, _x.parking_brake.status, _x.stationary))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.brake_torque_request, _x.brake_torque_actual, _x.wheel_torque_actual, _x.accel_over_ground, _x.hsa.status, _x.hsa.mode, _x.abs_active, _x.abs_enabled, _x.stab_active, _x.stab_enabled, _x.trac_active, _x.trac_enabled, _x.parking_brake.status, _x.stationary,) = _struct_4f10B.unpack(str[start:end])
