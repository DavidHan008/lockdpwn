...
class BrakeCmd(genpy.Message):
  _md5sum = "c0d20e1056976680942e85ab0959826c"
...
"""
  ...
  __slots__ = ['pedal_cmd','pedal_cmd_type','boo_cmd','enable','clear','ignore','count']
  _slot_types = ['float32','uint8','bool','bool','bool','bool','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pedal_cmd,pedal_cmd_type,boo_cmd,enable,clear,ignore,count
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_f6B.pack(_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.clear, _x.ignore, _x.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_cmd, _x.pedal_cmd_type, _x.boo_cmd, _x.enable, _x.clear, _x.ignore, _x.count,) = _struct_f6B.unpack(str[start:end])
