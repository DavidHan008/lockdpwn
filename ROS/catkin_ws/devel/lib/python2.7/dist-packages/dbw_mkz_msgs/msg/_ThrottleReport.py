...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f8B.pack(_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.enabled, _x.override, _x.driver, _x.watchdog_counter.source, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_connector))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.enabled, _x.override, _x.driver, _x.watchdog_counter.source, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_connector,) = _struct_3f8B.unpack(str[start:end])
