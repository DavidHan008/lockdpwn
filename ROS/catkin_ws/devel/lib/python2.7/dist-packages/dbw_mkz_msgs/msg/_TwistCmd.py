...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6d2f.pack(_x.twist.linear.x, _x.twist.linear.y, _x.twist.linear.z, _x.twist.angular.x, _x.twist.angular.y, _x.twist.angular.z, _x.accel_limit, _x.decel_limit))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.twist.linear.x, _x.twist.linear.y, _x.twist.linear.z, _x.twist.angular.x, _x.twist.angular.y, _x.twist.angular.z, _x.accel_limit, _x.decel_limit,) = _struct_6d2f.unpack(str[start:end])
      return self
