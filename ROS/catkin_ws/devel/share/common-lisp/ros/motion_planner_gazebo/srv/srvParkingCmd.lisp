...
(cl:in-package motion_planner_gazebo-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <srvParkingCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvParkingCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_planner_gazebo-srv:<srvParkingCmd-request> is deprecated: use motion_planner_gazebo-srv:srvParkingCmd-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <srvParkingCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planner_gazebo-srv:x-val is deprecated.  Use motion_planner_gazebo-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <srvParkingCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planner_gazebo-srv:y-val is deprecated.  Use motion_planner_gazebo-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <srvParkingCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planner_gazebo-srv:theta-val is deprecated.  Use motion_planner_gazebo-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <srvParkingCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planner_gazebo-srv:mode-val is deprecated.  Use motion_planner_gazebo-srv:mode instead.")
  (mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvParkingCmd-request>)))
  ...
  "motion_planner_gazebo/srvParkingCmdRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvParkingCmd-request)))
  "Returns string type for a service object of type 'srvParkingCmd-request"
  "motion_planner_gazebo/srvParkingCmdRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srvParkingCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvParkingCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_planner_gazebo-srv:<srvParkingCmd-response> is deprecated: use motion_planner_gazebo-srv:srvParkingCmd-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <srvParkingCmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planner_gazebo-srv:result-val is deprecated.  Use motion_planner_gazebo-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvParkingCmd-response>)))
  ...
  "motion_planner_gazebo/srvParkingCmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvParkingCmd-response)))
  "Returns string type for a service object of type 'srvParkingCmd-response"
  "motion_planner_gazebo/srvParkingCmdResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvParkingCmd)))
  ...
  "motion_planner_gazebo/srvParkingCmd")