...
if("TRUE" STREQUAL "TRUE")
  set(loam_velodyne_SOURCE_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/catkin_ws/src/loam_velodyne)
  set(loam_velodyne_DEVEL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/catkin_ws/devel)
  ...
  set(loam_velodyne_INSTALL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'loam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ji Zhang <zhangji@cmu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'loam_velodyne' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/gitrepo/lockdpwn/ROS/catkin_ws/src/loam_velodyne/${idir}'.  Ask the maintainer 'Ji Zhang <zhangji@cmu.edu>' to fix it.")
    endif()
