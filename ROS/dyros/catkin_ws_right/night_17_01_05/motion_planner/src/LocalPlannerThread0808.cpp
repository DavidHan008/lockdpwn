    ...
    :m_bThreadStop(false),init_argc(argc), init_argv(argv)
{
    ...
    msgpub_Look_JW = n.advertise<visualization_msgs::Marker>("LookAheadPos", 10);//real use data
...
// Generation of Interpolation Curve
        CatmullRomSpline spline;
        vector<Vector2d> curvePath = spline.PathToCurve( nodeVec, 1, 10);
        m_LocalSplinePath = curvePath;
