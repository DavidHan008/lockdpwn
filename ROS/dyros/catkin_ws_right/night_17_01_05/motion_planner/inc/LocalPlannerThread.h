...
public :
    ...
    void GetLookAheadPt_JW_for(double &lookAheadDist,double& x, double& y, double &resdist);//JW 16.08.24.
    void GetLookAheadPt_JW_rev(double &lookAheadDist,double& x, double& y, double &resdist);//JW 16.08.24.	
