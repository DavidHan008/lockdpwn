    ...
    :m_bThreadStop(false),init_argc(argc), init_argv(argv)
{
    ...
    m_model_jw.scale.x = 1.3;
    m_model_jw.scale.y = 1.3;
    m_model_jw.scale.z = 1.3;
    m_model_jw.color.a = 1.3;
    ...
    m_model_orig.color.g = 1.0f;
    m_model_orig.color.b = 0.0f;
    //jw 16.07.08
