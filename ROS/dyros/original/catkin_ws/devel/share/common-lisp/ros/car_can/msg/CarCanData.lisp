...
(cl:defmethod cl:initialize-instance :after ((m <CarCanData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarCanData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car_can-msg:<CarCanData> is deprecated: use car_can-msg:CarCanData instead.")))

(cl:ensure-generic-function 't-val :lambda-list '(m))
(cl:defmethod t-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:t-val is deprecated.  Use car_can-msg:t instead.")
  (t m))

(cl:ensure-generic-function 'gyro-val :lambda-list '(m))
(cl:defmethod gyro-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:gyro-val is deprecated.  Use car_can-msg:gyro instead.")
  (gyro m))

(cl:ensure-generic-function 'accl-val :lambda-list '(m))
(cl:defmethod accl-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:accl-val is deprecated.  Use car_can-msg:accl instead.")
  (accl m))

(cl:ensure-generic-function 'magnet-val :lambda-list '(m))
(cl:defmethod magnet-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:magnet-val is deprecated.  Use car_can-msg:magnet instead.")
  (magnet m))

(cl:ensure-generic-function 'sas-val :lambda-list '(m))
(cl:defmethod sas-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:sas-val is deprecated.  Use car_can-msg:sas instead.")
  (sas m))

(cl:ensure-generic-function 'obdVel1-val :lambda-list '(m))
(cl:defmethod obdVel1-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:obdVel1-val is deprecated.  Use car_can-msg:obdVel1 instead.")
  (obdVel1 m))

(cl:ensure-generic-function 'obdVel2-val :lambda-list '(m))
(cl:defmethod obdVel2-val ((m <CarCanData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_can-msg:obdVel2-val is deprecated.  Use car_can-msg:obdVel2 instead.")
  (obdVel2 m))
