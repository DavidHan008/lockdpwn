...
void LocalPlannerThread::GetLookAheadPt(double lookAheadDist,double& x, double& y, double &resdist, int &carIdx)
{
...
void LocalPlannerThread::Compute()
{
    ...
    if (m_dir_mode == 1)//m_switch_flag
    {
        ...
        {
            //printf("%lf\n",m_vel);
            GetLookAheadPt(2.24*m_vel, x, y, resdist, carIdx);
        }
        else
        {
            GetLookAheadPt(3.3, x, y, resdist, carIdx);
        }
...
/*
        ...
        steer = steer_Radius;
*/
        cout << "steer_Purepursuit : " << steer_Purepursuit
