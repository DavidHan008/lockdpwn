...
System requirements
-------------------
* PC with Linux Kernel 2.6.X or 3.X.X
* IXXAT CAN Interface: 
  - "PC-I 04/PCI"
  - "PC-I 04/104"
  - "iPC-I 320/PCI"
...
Note: 
  The driver should work with most Linux distributions running a 2.6.x or 
  3.X.X Kernel, but was only tested using Debian/Ubuntu and openSUSE Linux.
...
2) To install the kernel module run 'make install'.
   ...
   libraries to '/usr/lib', set up all necessary links and run "ldconfig"
...
2) Navigate to 'EciLinux_[ARCH]/bin/ia32/release' (where [ARCH] can be
...
ECI API
-------
1) The ECI Header files can be found in the folder EciLinux_[ARCH]/src/EciDrivers/
   common/ECI
