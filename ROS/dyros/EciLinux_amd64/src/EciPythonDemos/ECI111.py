...
class ECI111:
    ...
    def __init__(self):
        # Loads the ECI.so
        #     
        self.dll = cdll.LoadLibrary("libeci111DriverLinux.so")
        if self.dll == None:
    ...
    def ECIDRV_Initialize (
        ...
        try:
            res = self.dll.ECI111_Initialize(DWORD(dwCount), byref(astcHwPara))
            return res
        except :
    ...
    def ECIDRV_GetInfo (
        ...
        pstcHwInfo):
        try:
            res = self.dll.ECI111_GetInfo(dwHwIndex, byref(pstcHwInfo))
            return res
        except:
    ...
    def ECIDRV_CtrlOpen (
        ...
        pstcCtrlConfig):
        try:
            res = self.dll.ECI111_CtrlOpen(byref(phCtrl), dwHwIndex, dwCtrlIndex, byref(pstcCtrlConfig))
            return res
        except:
    ...
    def ECIDRV_CtrlClose (
        ...
        hCtrl):
        try:
            res = self.dll.ECI111_CtrlClose(hCtrl)
            return res
        except:
    ...
    def ECIDRV_CtrlStart (
        ...
        hCtrl):
        try:
            res = self.dll.ECI111_CtrlStart(hCtrl)
            return res
        except:
    ...
    def ECIDRV_CtrlStop  (
        ...
        dwMode):
        try:
            res = self.dll.ECI111_CtrlStop(hCtrl, dwMode)
            return res
        except:
    ...
    def ECIDRV_CtrlGetCapabilities (
        ...
        pstcCapabilities):
        try:
            res = self.dll.ECI111_CtrlGetCapabilities(hCtrl, byref(pstcCapabilities))
            return res
        except:
    ...
    def ECIDRV_CtrlGetStatus (
        ...
        pstcStatus):
        try:
            res = self.dll.ECI111_CtrlGetStatus(hCtrl, byref(pstcStatus))
            return res
        except:
    ...
    def ECIDRV_CtrlSend (
        ...
        dwTimeout):
        try:
            res = self.dll.ECI111_CtrlSend(hCtrl, byref(pstcMessage), dwTimeout)
            return res
        except:
    ...
    def ECIDRV_CtrlReceive (
        ...
        dwTimeout):
        try:
            res = self.dll.ECI111_CtrlReceive(hCtrl, byref(pdwCount), byref(pstcMessage), dwTimeout)
            return res
        except:
    ...
    def ECIDRV_CtrlSetAccFilter(
        ...
        pstcFilter):
        try:
            res = self.dll.ECI111_CtrlSetAccFilter(hCtrl,
                                                   byref(pstcFilter))
            return res
        except:
    ...
    def ECIDRV_CtrlAddFilterIds(
        ...
        pstcFilter):
        try:
            res = self.dll.ECI111_CtrlAddFilterIds(hCtrl,
                                                   byref(pstcFilter))
            return res
        except:
            print("Exception on ECIBasic.ECIDRV_CtrlSetFilter")
    ...
    def ECIDRV_CtrlRemFilterIds(
        ...
        pstcFilter):
        try:
            res = self.dll.ECI111_CtrlRemFilterIds(hCtrl,
                                                   byref(pstcFilter))
            return res
        except:
            print("Exception on ECIBasic.ECIDRV_CtrlSetFilter")
    ...
    def ECIDRV_CtrlCommand (
        ...
        dwTimeout):
        try:
            res = self.dll.ECI111_CtrlCommand(hCtrl, byref(pstcCmdRequest), byref(pstcCmdResponse), dwTimeout)
            return res
        except:
    ...
    def ECIDRV_LogConfig (
        ...
        pstcConfig):
        try:
            res = self.dll.ECI111_LogConfig(byref(pstcConfig))
            return res
        except:
    ...
    def ECIDRV_LogRead (
        ...
        dwTimeout):
        try:
            res = self.dll.ECI111_LogRead(byref(pdwCount), byref(astcEntry), dwTimeout)
            return res
        except:
    ...
    def ECIDRV_GetErrorString (
        ...
        dwError):
        try:
            self.dll.ECI111_GetErrorString.restype = c_char_p
            res = self.dll.ECI111_GetErrorString(dwError)
