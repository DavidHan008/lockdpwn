...
if("TRUE" STREQUAL "TRUE")
  set(seven_dof_arm_config_SOURCE_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/seven_dof_arm_config)
  set(seven_dof_arm_config_DEVEL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/devel)
  ...
  set(seven_dof_arm_config_INSTALL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'seven_dof_arm_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'edward <gyurse@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'seven_dof_arm_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/seven_dof_arm_config/${idir}'.  Ask the maintainer 'edward <gyurse@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${seven_dof_arm_config_dep}_FOUND)
      find_package(${seven_dof_arm_config_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${seven_dof_arm_config_dep} REQUIRED ${depend_list})
  endif()
