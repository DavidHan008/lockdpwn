...
if("TRUE" STREQUAL "TRUE")
  set(chefbot_bringup_SOURCE_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/chefbot_bringup)
  set(chefbot_bringup_DEVEL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/devel)
  ...
  set(chefbot_bringup_INSTALL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chefbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/chefbot_bringup/${idir}'.  Ask the maintainer 'lentin <lentin@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${chefbot_bringup_dep}_FOUND)
      find_package(${chefbot_bringup_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${chefbot_bringup_dep} REQUIRED ${depend_list})
  endif()
