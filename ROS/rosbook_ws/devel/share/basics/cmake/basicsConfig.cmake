...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/basics)
  set(basics_DEVEL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/install)
...
if(NOT "/home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/devel/include " STREQUAL " ")
  set(basics_INCLUDE_DIRS "")
  set(_include_dirs "/home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jongmin <jongmin@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/gitrepo/lockdpwn/ROS/rosbook_ws/src/basics/${idir}'.  Ask the maintainer 'jongmin <jongmin@todo.todo>' to fix it.")
    endif()
