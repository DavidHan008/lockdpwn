...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%~%# 피드백 : 실행되는 동안 서버가 주기적으로 보냄~%~%# 시작부터 경과된 시간~%duration time_elapsed~%# 종료될 때까지 남은 시간~%duration time_remaining~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerFeedback)))
  "Returns full string definition for message of type 'TimerFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%~%# 피드백 : 실행되는 동안 서버가 주기적으로 보냄~%~%# 시작부터 경과된 시간~%duration time_elapsed~%# 종료될 때까지 남은 시간~%duration time_remaining~%~%~%~%"))
