...
#-*- coding: utf-8 -*-
'''
	python ==> ROS programming,	turtlebot의 속도를 Ramp입력을 통해 점진적으로 주는 함수를 구현한 코드
...
def ramped_vel(v_prev, v_target, t_prev, t_now, ramp_rate):
	...
	if error < step:   # 이 timestep 안에 도달 - 끝났음
		return v_target
	else:
		return v_prev + sign * step  # 목적지로 향해서 나아감
...
def send_twist():
	global g_last_twist_send_time, g_target_twist, g_last_twist, g_vel_scales, g_twist_pub, g_vel_ramps
