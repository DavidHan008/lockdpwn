...
(cl:in-package rndf_manager-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <srvHeightMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvHeightMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rndf_manager-srv:<srvHeightMap-request> is deprecated: use rndf_manager-srv:srvHeightMap-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <srvHeightMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rndf_manager-srv:x-val is deprecated.  Use rndf_manager-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <srvHeightMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rndf_manager-srv:y-val is deprecated.  Use rndf_manager-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <srvHeightMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rndf_manager-srv:theta-val is deprecated.  Use rndf_manager-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <srvHeightMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rndf_manager-srv:mode-val is deprecated.  Use rndf_manager-srv:mode instead.")
  (mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvHeightMap-request>)))
  ...
  "rndf_manager/srvHeightMapRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvHeightMap-request)))
  "Returns string type for a service object of type 'srvHeightMap-request"
  "rndf_manager/srvHeightMapRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <srvHeightMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'srvHeightMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rndf_manager-srv:<srvHeightMap-response> is deprecated: use rndf_manager-srv:srvHeightMap-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <srvHeightMap-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rndf_manager-srv:result-val is deprecated.  Use rndf_manager-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<srvHeightMap-response>)))
  ...
  "rndf_manager/srvHeightMapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'srvHeightMap-response)))
  "Returns string type for a service object of type 'srvHeightMap-response"
  "rndf_manager/srvHeightMapResponse")
