...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grid_map_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/catkin_ws/install/${idir}'.  Ask the maintainer 'Philipp Krüsi <kruesip@ethz.ch>' to fix it.")
    endif()
