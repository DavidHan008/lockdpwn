...
* CAN baud rates
****************************************************************************/
#define ECI_CAN_BTP_10KB    {0,    10000, 13, 2, 1, 0}   ///<    10 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_20KB    {0,    20000, 13, 2, 1, 0}   ///<    20 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_50KB    {0,    50000, 13, 2, 1, 0}   ///<    50 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_100KB   {0,   100000, 13, 2, 1, 0}   ///<   100 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_125KB   {0,   125000, 13, 2, 1, 0}   ///<   125 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_250KB   {0,   250000, 13, 2, 1, 0}   ///<   250 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_500KB   {0,   500000, 13, 2, 1, 0}   ///<   500 KB, SP 87,5% @ingroup CanTypes
#define ECI_CAN_BTP_800KB   {0,   800000,  7, 2, 1, 0}   ///<   800 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_BTP_1000KB  {0,  1000000,  5, 2, 1, 0}   ///<  1000 KB, SP 75,0% @ingroup CanTypes


/*****************************************************************************
* CAN FD baud rates, used for arbitration and fast data rate
****************************************************************************/
#define ECI_CAN_SDR_BTP_500KB   {0,   500000, 63, 16,  16, 0}   ///<   500 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_SDR_BTP_1000KB  {0,  1000000, 31,  8,   8, 0}   ///<  1000 KB, SP 80,0% @ingroup CanTypes

#define ECI_CAN_FDR_BTP_2000KB  {0,  2000000, 15,  4,  4, 32}   ///<  2000 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_4000KB  {0,  4000000,  7,  2,  2, 16}   ///<  4000 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_5000KB  {0,  5000000,  5,  2,  2, 12}   ///<  5000 KB, SP 75,0% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_6666KB  {0,  6666666,  3,  2,  2,  8}   ///<  6666 KB, SP 66,7% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_8000KB  {0,  8000000,  3,  1,  1,  8}   ///<  8000 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_10000KB {0, 10000000,  2,  1,  1,  6}   ///< 10000 KB, SP 75,0% @ingroup CanTypes
