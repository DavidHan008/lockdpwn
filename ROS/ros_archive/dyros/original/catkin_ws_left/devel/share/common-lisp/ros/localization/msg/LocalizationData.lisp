...
(cl:defmethod cl:initialize-instance :after ((m <LocalizationData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalizationData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization-msg:<LocalizationData> is deprecated: use localization-msg:LocalizationData instead.")))
...
(cl:defmethod v-val ((m <LocalizationData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-msg:v-val is deprecated.  Use localization-msg:v instead.")
  (v m))
