    ...
    :m_bThreadStop(false),init_argc(argc), init_argv(argv)
{
    ...
    m_model_jw.scale.x = 0.7;	m_model_jw_exp.scale.x = 0.7;
    m_model_jw.scale.y = 0.7;	m_model_jw_exp.scale.y = 0.7;
    m_model_jw.scale.z = 0.1;	m_model_jw_exp.scale.z = 0.7;
    m_model_jw.color.a = 1.0;	m_model_jw_exp.color.a = 1.0;
    m_model_jw.color.r = 1.0f;	m_model_jw_exp.color.r = 0.0f;
    m_model_jw.color.g = 1.0f;	m_model_jw_exp.color.g = 0.0f;
    m_model_jw.color.b = 0.0f;	m_model_jw_exp.color.b = 1.0f;

    m_model_jw_exp_line.scale.x = 0.09;
    m_model_jw_exp_line.pose.position.z = 0.05;
    m_model_jw_exp_line.color.r = 1.0;
    ...
    m_model_orig.scale.x = 0.5;
    m_model_orig.scale.y = 0.5;
    m_model_orig.scale.z = 0.5;
    m_model_orig.color.a = 1.0;
    m_model_orig.color.r = 0.0f;
    m_model_orig.color.g = 0.0f;
    m_model_orig.color.b = 0.5f;
    //jw 16.07.08
...
//	double theta = atan2((y - m_pos[1]), (x - m_pos[0]));
...
//	m_model_jw.pose.position.x = x + m_overall*cos(theta);
//	m_model_jw.pose.position.y = y + m_overall*sin(theta);
