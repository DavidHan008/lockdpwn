...
if("TRUE" STREQUAL "TRUE")
  set(grid_map_rviz_plugin_SOURCE_PREFIX /home/dyros-vehicle/catkin_ws/src/grid_map/grid_map_rviz_plugin)
  set(grid_map_rviz_plugin_DEVEL_PREFIX /home/dyros-vehicle/catkin_ws/devel)
  ...
  set(grid_map_rviz_plugin_INSTALL_PREFIX /home/dyros-vehicle/catkin_ws/install)
...
if(NOT "/home/dyros-vehicle/catkin_ws/src/grid_map/grid_map_rviz_plugin/include " STREQUAL " ")
  set(grid_map_rviz_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/dyros-vehicle/catkin_ws/src/grid_map/grid_map_rviz_plugin/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'grid_map_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Philipp Krüsi <kruesip@ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'grid_map_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dyros-vehicle/catkin_ws/src/grid_map/grid_map_rviz_plugin/${idir}'.  Ask the maintainer 'Philipp Krüsi <kruesip@ethz.ch>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${grid_map_rviz_plugin_dep}_FOUND)
      find_package(${grid_map_rviz_plugin_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${grid_map_rviz_plugin_dep} REQUIRED ${depend_list})
  endif()
