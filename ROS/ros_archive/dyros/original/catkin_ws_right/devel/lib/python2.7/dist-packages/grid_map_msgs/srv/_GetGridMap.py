...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4d.pack(_x.position_x, _x.position_y, _x.length_x, _x.length_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position_x, _x.position_y, _x.length_x, _x.length_y,) = _struct_4d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.layers = []
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.map.info.header.seq, _x.map.info.header.stamp.secs, _x.map.info.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10d.pack(_x.map.info.resolution, _x.map.info.length_x, _x.map.info.length_y, _x.map.info.pose.position.x, _x.map.info.pose.position.y, _x.map.info.pose.position.z, _x.map.info.pose.orientation.x, _x.map.info.pose.orientation.y, _x.map.info.pose.orientation.z, _x.map.info.pose.orientation.w))
      ...
      _x = self
      buff.write(_struct_2H.pack(_x.map.outer_start_index, _x.map.inner_start_index))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.map.info.header.seq, _x.map.info.header.stamp.secs, _x.map.info.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.map.info.resolution, _x.map.info.length_x, _x.map.info.length_y, _x.map.info.pose.position.x, _x.map.info.pose.position.y, _x.map.info.pose.position.z, _x.map.info.pose.orientation.x, _x.map.info.pose.orientation.y, _x.map.info.pose.orientation.z, _x.map.info.pose.orientation.w,) = _struct_10d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.map.layers = []
      ...
      (_x.map.outer_start_index, _x.map.inner_start_index,) = _struct_2H.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
