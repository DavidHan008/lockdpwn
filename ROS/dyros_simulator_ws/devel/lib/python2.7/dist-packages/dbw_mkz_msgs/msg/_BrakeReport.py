...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6f13B.pack(_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.torque_input, _x.torque_cmd, _x.torque_output, _x.boo_input, _x.boo_cmd, _x.boo_output, _x.enabled, _x.override, _x.driver, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_boo, _x.fault_connector))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_input, _x.pedal_cmd, _x.pedal_output, _x.torque_input, _x.torque_cmd, _x.torque_output, _x.boo_input, _x.boo_cmd, _x.boo_output, _x.enabled, _x.override, _x.driver, _x.watchdog_counter.source, _x.watchdog_braking, _x.fault_wdc, _x.fault_ch1, _x.fault_ch2, _x.fault_boo, _x.fault_connector,) = _struct_6f13B.unpack(str[start:end])
