...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4f8B.pack(_x.steering_wheel_angle, _x.steering_wheel_angle_cmd, _x.steering_wheel_torque, _x.speed, _x.enabled, _x.override, _x.driver, _x.fault_wdc, _x.fault_bus1, _x.fault_bus2, _x.fault_calibration, _x.fault_connector))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.steering_wheel_angle, _x.steering_wheel_angle_cmd, _x.steering_wheel_torque, _x.speed, _x.enabled, _x.override, _x.driver, _x.fault_wdc, _x.fault_bus1, _x.fault_bus2, _x.fault_calibration, _x.fault_connector,) = _struct_4f8B.unpack(str[start:end])
