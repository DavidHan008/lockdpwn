...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4B.pack(_x.state.gear, _x.cmd.gear, _x.override, _x.fault_bus))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.gear, _x.cmd.gear, _x.override, _x.fault_bus,) = _struct_4B.unpack(str[start:end])
