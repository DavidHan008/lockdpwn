...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_f5B.pack(_x.pedal_cmd, _x.pedal_cmd_type, _x.enable, _x.clear, _x.ignore, _x.count))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pedal_cmd, _x.pedal_cmd_type, _x.enable, _x.clear, _x.ignore, _x.count,) = _struct_f5B.unpack(str[start:end])
