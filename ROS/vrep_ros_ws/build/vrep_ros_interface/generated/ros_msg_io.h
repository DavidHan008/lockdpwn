...
void write__driver_base__ConfigString(const driver_base::ConfigString& msg, int stack, const WriteOptions *opt = NULL);

void read__driver_base__ConfigString(int stack, driver_base::ConfigString *msg, const ReadOptions *opt = NULL);
...
void write__driver_base__ConfigValue(const driver_base::ConfigValue& msg, int stack, const WriteOptions *opt = NULL);

void read__driver_base__ConfigValue(int stack, driver_base::ConfigValue *msg, const ReadOptions *opt = NULL);
...
void write__driver_base__SensorLevels(const driver_base::SensorLevels& msg, int stack, const WriteOptions *opt = NULL);

void read__driver_base__SensorLevels(int stack, driver_base::SensorLevels *msg, const ReadOptions *opt = NULL);
