...
void write__driver_base__ConfigString(const driver_base::ConfigString& msg, int stack, const WriteOptions *opt)
{
    try
    {
        simPushTableOntoStackE(stack);
    ...
    {
        std::string msg = "write__driver_base__ConfigString: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void read__driver_base__ConfigString(int stack, driver_base::ConfigString *msg, const ReadOptions *opt)
{
    try
    {
        int r = simGetStackTableInfoE(stack, 0);
    ...
    {
        std::string msg = "read__driver_base__ConfigString: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void ros_callback__driver_base__ConfigString(const boost::shared_ptr<driver_base::ConfigString const>& msg, SubscriberProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = simCreateStackE();
        write__driver_base__ConfigString(*msg, stack, &(proxy->wr_opt));
        simCallScriptFunctionExE(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        simReleaseStackE(stack);
        stack = -1;
    }
    catch(exception& ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__driver_base__ConfigString: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
...
void write__driver_base__ConfigValue(const driver_base::ConfigValue& msg, int stack, const WriteOptions *opt)
{
    try
    {
        simPushTableOntoStackE(stack);
    ...
    {
        std::string msg = "write__driver_base__ConfigValue: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void read__driver_base__ConfigValue(int stack, driver_base::ConfigValue *msg, const ReadOptions *opt)
{
    try
    {
        int r = simGetStackTableInfoE(stack, 0);
    ...
    {
        std::string msg = "read__driver_base__ConfigValue: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void ros_callback__driver_base__ConfigValue(const boost::shared_ptr<driver_base::ConfigValue const>& msg, SubscriberProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = simCreateStackE();
        write__driver_base__ConfigValue(*msg, stack, &(proxy->wr_opt));
        simCallScriptFunctionExE(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        simReleaseStackE(stack);
        stack = -1;
    }
    catch(exception& ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__driver_base__ConfigValue: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
...
void write__driver_base__SensorLevels(const driver_base::SensorLevels& msg, int stack, const WriteOptions *opt)
{
    try
    {
        simPushTableOntoStackE(stack);
    ...
    {
        std::string msg = "write__driver_base__SensorLevels: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void read__driver_base__SensorLevels(int stack, driver_base::SensorLevels *msg, const ReadOptions *opt)
{
    try
    {
        int r = simGetStackTableInfoE(stack, 0);
    ...
    {
        std::string msg = "read__driver_base__SensorLevels: ";
        msg += ex.what();
        throw exception(msg);
    }
}
...
void ros_callback__driver_base__SensorLevels(const boost::shared_ptr<driver_base::SensorLevels const>& msg, SubscriberProxy *proxy)
{
    int stack = -1;
    try
    {
        stack = simCreateStackE();
        write__driver_base__SensorLevels(*msg, stack, &(proxy->wr_opt));
        simCallScriptFunctionExE(proxy->topicCallback.scriptId, proxy->topicCallback.name.c_str(), stack);
        simReleaseStackE(stack);
        stack = -1;
    }
    catch(exception& ex)
    {
        if(stack != -1)
            simReleaseStack(stack); // don't throw
        std::string msg = "ros_callback__driver_base__SensorLevels: ";
        msg += ex.what();
        simSetLastError(proxy->topicCallback.name.c_str(), msg.c_str());
    }
}
