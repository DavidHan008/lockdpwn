    ...
    else if(publisherProxy->topicType == "driver_base/ConfigString")
    {
        driver_base::ConfigString msg;
        read__driver_base__ConfigString(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    else if(publisherProxy->topicType == "driver_base/ConfigValue")
    {
        driver_base::ConfigValue msg;
        read__driver_base__ConfigValue(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
    else if(publisherProxy->topicType == "driver_base/SensorLevels")
    {
        driver_base::SensorLevels msg;
        read__driver_base__SensorLevels(p->stackID, &msg, &(publisherProxy->rd_opt));
        publisherProxy->publisher.publish(msg);
    }
